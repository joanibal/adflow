...
!
    ...
    use utils_fast_b, only : terminate, sitemperature
...
&   winf
    use inputphysics, only : equations
    use utils_fast_b, only : sidensity, sivelocity, sipressure, siangle, &
...
!
    ...
    use utils_fast_b, only : terminate, sipressure
...
&   pref, muref
    ...
    use utils_fast_b, only : sidensity, sipressure, sivelocity, sitemperature&
&   , terminate
    implicit none
!
!      subroutine arguments.
...
!
    ...
    use inputphysics, only : equations, turbmodel
    use utils_fast_b, only : terminate, siturb
    implicit none
!
!      subroutine arguments.
!

...
&           iheatedarea, sps)
        ...
        globalvalsd(itotheattransfer, sps) = globalvalsd(&
&         itotheattransfer, sps) + ovrnts*funcvaluesd(&
&         costfunctotheattransfer)
...
! heat flux done is seperate loop to prevent the type check from being run for each cell
    ...
    qd = localvaluesd(itotheattransfer)
...
&       zc*sepsensoravgd(3)
      ...
      vd(1) = 0.0_8
      cellaread = cellaread + bcdatad(mm)%area(i, j) + blk*aread

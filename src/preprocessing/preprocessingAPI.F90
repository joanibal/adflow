...
101 format("CGNS Block ",I4,", boundary condition ",I4, ", of type ",a, &
  ...
  subroutine createNodeScatterForFamilies(famList, exch, sps, localIndices)
    ...
    call VecDuplicate(exch%nodeValLocal, exch%nodeValLocald,  ierr)
    call EChk(ierr,__FILE__,__LINE__)
    ...
    call VecDuplicate(exch%nodeValGlobal, exch%nodeValGlobald,  ierr)
    call EChk(ierr,__FILE__,__LINE__)
    ...
    call VecDuplicate(exch%sumGlobal, exch%sumGlobald, ierr)
    call EChk(ierr,__FILE__,__LINE__)

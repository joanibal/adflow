    ...
    def apply_linear(self, inputs, outputs, d_inputs, d_outputs, d_residuals, mode):
        ...
        if mode == "fwd":
            if "states" in d_residuals:
                ...
                dwdot = solver.computeJacobianVectorProductFwd(xDvDot=xDvDot, wDot=wDot, residualDeriv=True)
            ...
            if "states" in d_residuals:
                ...
                wBar, xDVBar = solver.computeJacobianVectorProductBwd(resBar=resBar, wDeriv=True, xDvDeriv=True)
